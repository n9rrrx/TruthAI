        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12">
            <div class="max-w-md mx-auto w-full">
                ...
                <p class="text-slate-500 dark:text-slate-400 mb-8">
                    Sign in to continue detecting AI content.
                </p>
                ...
                <form class="space-y-5">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <a href="/forgot-password" class="text-sm text-brand-primary hover:underline">Forgot password?</a>
                        </div>
                        <div class="relative">
                            <input type="password" id="password" placeholder="Enter your password" class="input-field w-full px-4 py-3 rounded-xl text-slate-800 dark:text-white outline-none pr-12">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="checkbox" id="remember" class="w-4 h-4 rounded border-slate-300 dark:border-slate-600 text-brand-primary focus:ring-brand-primary">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button class="social-btn flex items-center justify-center gap-2 py-3 px-4 rounded-xl font-medium text-slate-700 dark:text-white">
