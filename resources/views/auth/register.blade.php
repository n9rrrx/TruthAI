            ...
            <div class="max-w-md mx-auto w-full">
                ...
                <form class="space-y-5">
                    <div>
                        ...
                        <input type="text" placeholder="Enter your name" class="input-field w-full px-4 py-3 rounded-xl text-slate-800 dark:text-white outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="password" placeholder="Create a password" class="input-field w-full px-4 py-3 rounded-xl text-slate-800 dark:text-white outline-none pr-12">
