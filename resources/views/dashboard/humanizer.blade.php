    ...
    <div class="grid lg:grid-cols-2 gap-6">
        ...
        <div class="card rounded-2xl p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs text-slate-400">0 / 5000 characters</span>
            </div>
            
            <textarea id="original-text" class="input-field w-full h-80 p-4 rounded-xl resize-none outline-none" placeholder="Paste your AI-generated text here..."></textarea>

            <!-- Options -->
            <div class="mt-4 space-y-4">
                <div>
                    <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Writing Style</label>
                    <select class="input-field w-full p-3 rounded-xl outline-none">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <button class="flex-1 py-2 px-4 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 text-sm font-medium hover:bg-slate-200 dark:hover:bg-white/10 transition-colors">Light</button>
                        <button class="flex-1 py-2 px-4 rounded-lg bg-brand-primary text-white text-sm font-medium">Medium</button>
                        <button class="flex-1 py-2 px-4 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 text-sm font-medium hover:bg-slate-200 dark:hover:bg-white/10 transition-colors">Strong</button>
                    </div>
                </div>
            </div>
        ...
        <div class="card rounded-2xl p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex gap-2">
                    <button class="p-2 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-white/10 transition-colors" title="Copy">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                    </button>
                    <button class="p-2 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-white/10 transition-colors" title="Download">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                    </button>
                </div>
            </div>
            
            <div class="h-80 p-4 rounded-xl bg-slate-50 dark:bg-white/5 overflow-y-auto">
                <p class="text-slate-700 dark:text-slate-300 leading-relaxed">
                    To be honest, the way AI is advancing has really sparked a lot of debate around the world about whether automation is ethical or not. Some folks argue that AI could seriously boost how productive we are and help solve tricky problems we couldn't crack before. But others have some pretty valid points about people losing their jobs and our privacy getting eroded. On top of that, when algorithms make decisions without being transparent about it, that's a real threat to how our democratic systems work.
                </p>
            </div>
            ...
            <div class="mt-4 p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-bold text-green-600 dark:text-green-400">Likely Human Written</p>
                            <p class="text-sm text-green-500/80">Passes most detection tools</p>
                        </div>
                    </div>
            ...
            <div class="mt-4 flex gap-3">
                <button class="flex-1 py-3 rounded-xl border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                    Regenerate
                </button>
                <button class="flex-1 py-3 rounded-xl border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 font-medium hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                    Make More Human
